...
| AnimatorControllerParameter(/apis/core/#AnimatorControllerParameter)                   | Variables used in the animation controller, allowing users to change variables in scripts to control animation state transitions.                                                                  |
...
| [AnimatorStateMachine](/apis/core/#AnimatorStateMachine)        | Each AnimatorControllerLayer has an AnimatorStateMachine for controlling  `AnimatorState`  playback, transitions between states, and transitions.                                                     |
