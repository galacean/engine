...
- **Data Source**: Extracts graphic data from [Texture2D](/docs/graphics/texture/2d/)
...
- **Component Integration**:
  ...
  - Powers **[SpriteMask](/docs/graphics/2D/spriteMask/)**: Implements masking effects
...
1. **Right-click** in the **[Assets panel](/docs/assets/interface/)** blank area  
