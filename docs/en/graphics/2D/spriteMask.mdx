...
The **Sprite Mask** component is used to apply masking effects to [Sprite Renderers](/docs/graphics/2D/spriteRenderer/) and [Text Renderers](/docs/graphics/2D/text/) in 3D/2D scenes.
...
In the **[Hierarchy Panel](/docs/interface/hierarchy)**, **right-click** → **2D Object** → **Sprite Mask** to quickly create a node containing a Sprite Mask.
