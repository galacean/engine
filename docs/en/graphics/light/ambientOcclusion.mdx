...
Ambient Occlusion (AO) is a rendering technique that enhances scene realism by simulating how objects block ambient light in crevices, recesses, and contact points, making the scene look more grounded and natural.
...
| [Radius](/apis/core/#AmbientOcclusion-radius) | Controls the spread range of AO. Larger radius makes occlusion spread farther |
| [Bias](/apis/core/#AmbientOcclusion-bias) | Prevents self-occlusion artifacts, avoids surfaces darkening themselves |
...
- Too small → surfaces may darken themselves (self-occlusion artifacts).  
...
2. **Combine with other post-processing**  
   - Use with [Bloom](/docs/graphics/postProcess/effects/#bloom) and [Tonemapping](/docs/graphics/postProcess/effects/#tonemapping) to make AO blend more naturally into the final image.  
