...
The [generator](/apis/core/#ParticleGenerator) property of `ParticleRenderer` is mainly responsible for particle generation and playback. It is composed of multiple modules, including the [Main Module](/en/docs/graphics/particle/renderer-main-module), [Emission Module](/en/docs/graphics/particle/renderer-emission-module), [Size Over Lifetime Module](/en/docs/graphics/particle/renderer-size-module), [Color Module](/en/docs/graphics/particle/renderer-color-module), [Lifecycle Velocity Module](/en/docs/graphics/particle/renderer-velocity-module), [Lifecycle Force Module](/en/docs/graphics/particle/renderer-force-module), [Limit Velocity Over Lifetime Module](/en/docs/graphics/particle/renderer-limit-velocity-module), [Rotation Over Lifetime Module](/en/docs/graphics/particle/renderer-rotation-module), and [Texture Sheet Animation Module](/en/docs/graphics/particle/renderer-animation-module). In the editor's particle inspector panel, you can visually see each module and its options.
