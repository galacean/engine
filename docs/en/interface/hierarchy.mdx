...
In the hierarchy panel, you can edit the basic properties of entities and manage components. For more details, refer to the [Entity](/docs/core/entity) documentation.