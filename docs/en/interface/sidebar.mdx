...
You can search for new members using their email and assign them one of three permission levels: read-write, read-only, or edit. After successfully adding them, you can still edit the member's permission level or remove the member. You can also generate a shareable link to send to partners you want to collaborate with.
