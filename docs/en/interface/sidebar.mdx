...
- **Physics Backend**: Configure the physics backend used by physics components and raycast picking. The built-in backend is based on [PhysX](https://developer.nvidia.com/physx-sdk).
