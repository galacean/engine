...
| <img src="https://gw.alipayobjects.com/zos/OasisHub/37eec76d-a1f5-4687-862b-656bc59b781b/image-20250124174459582.png" style={{zoom:"50%"}} /> | Rectangle Edit Tool | Drag and scale sprites, GUI elements |  |
...
| Navigation Gizmo | Displays the current direction of the scene camera and allows for quick modifications of the view and projection mode (orthographic/perspective) via mouse operations. It appears in the lower-right corner of the screen when enabled.<br /><Image src="https://mdn.alipayobjects.com/huamei_qbugvr/afts/img/A*tooGS4MTpTUAAAAAAAAAAAAADtKFAQ/original" style={{zoom:"50%"}} /> |
...
| Camera | Displays the selected camera component as a frustum |
| Light | Displays the light component |
...
| Dynamic Clipping          | Automatically calculates the near and far clipping planes of the scene camera relative to the selected entity and scene camera position | Off               |
| Near Plane         | Manually adjusts the nearest point relative to the scene camera                               | Enabled when dynamic clipping is unchecked |
| Far Plane          | Manually adjusts the farthest point relative to the scene camera                               | Enabled when dynamic clipping is unchecked |
| Speed                | The movement speed of the camera in flight mode                                     | 10                   |
| Opaque Texture | Enables opaque texture for the scene camera                                       | Off                 |
| HDR                          | Enables HDR for the scene camera                                       | Off                 |
| Post Process       | Enables post-processing for the scene camera                                           | On                 |
