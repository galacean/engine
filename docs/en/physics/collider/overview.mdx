...
Currently, the built-in PhysX backend supports the following `collision shapes`:

| Name | Description |
| :-- | :-- |
| [BoxColliderShape](/apis/core/#BoxColliderShape) | Box-shaped collision shape |
| [SphereColliderShape](/apis/core/#SphereColliderShape) | Sphere-shaped collision shape |
| [PlaneColliderShape](/apis/core/#PlaneColliderShape) | Infinite plane collision shape |
| [CapsuleColliderShape](/apis/core/#CapsuleColliderShape) | Capsule-shaped collision shape |
