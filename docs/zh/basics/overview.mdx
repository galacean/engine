...
| [@galacean/engine-shader-compiler](https://www.npmjs.com/package/@galacean/engine-shader-compiler) | Galacean Shader 编译器 | [Doc](/docs/graphics/material/shader) |
...
| [@galacean/engine-ui](https://www.npmjs.com/package/@galacean/engine-ui) | UI | [Doc](/docs/UI/overall) |
...
| [PhysX](/docs/physics/overall) | [WebAssembly](https://caniuse.com/?search=wasm) | PhysX 依赖 WebAssembly；`Auto` 运行时模式只会在 SIMD 与非 SIMD WebAssembly 构建之间选择 |
