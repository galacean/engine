...
每个 Shader 有不同的渲染效果和应用场景，更多详情参考 [内置着色器教程](/docs/graphics/material/builtinShaders/pbr/) 和 [自定义 Shader 实战教程](/docs/graphics/material/examples/shader-01-basic-shader) 。
...
<Callout type="info">
具体 shader 内容编写可以从 [自定义 Shader 实战教程](/docs/graphics/material/examples/shader-01-basic-shader) 快速上手。
</Callout>
...
## 下一步学习
- [自定义 Shader](/docs/graphics/material/examples/shader-01-basic-shader) - 从 0 开始 Shader 创作之旅
