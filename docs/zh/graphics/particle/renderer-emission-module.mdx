...
| 发射器形状类型                                               | 释义                                 |
| ------------------------------------------------------------ | ------------------------------------ |
| [BoxShape](/apis/core/#BoxShape)               | `BoxShape` 对象，发射器形状为立方体 |
| [MeshShape](/apis/core/#MeshShape)             | `MeshShape` 对象，发射器形状为指定的 Mesh |
| [CircleShape](/apis/core/#CircleShape)         | `CircleShape` 对象，发射器形状为圆圈   |
| [ConeShape](/apis/core/#ConeShape)             | `ConeShape` 对象，发射器形状为类圆锥 |
| [HemisphereShape](/apis/core/#HemisphereShape) | `HemisphereShape` 对象，发射器形状为半球   |
| [SphereShape](/apis/core/#SphereShape)         | `SphereShape` 对象，发射器形状为球体   |
