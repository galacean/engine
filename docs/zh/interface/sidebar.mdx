...
- **Physics Backend**：配置物理组件和 Raycast 拾取使用的物理后端。内置后端基于 [PhysX](https://developer.nvidia.com/physx-sdk)。
...
你可以通过此按钮打开AI面板，目前支持[图生3D模型](/docs/AI/image2model)能力，后续的 AI 能力也会添加到这里。
