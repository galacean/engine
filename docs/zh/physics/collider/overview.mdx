...
目前内置 PhysX 后端支持以下 `碰撞形状`：

| 名称                                                     | 解释             |
| :------------------------------------------------------- | :--------------- |
| [BoxColliderShape](/apis/core/#BoxColliderShape)         | 盒形碰撞外形     |
| [SphereColliderShape](/apis/core/#SphereColliderShape)   | 球形碰撞外形     |
| [PlaneColliderShape](/apis/core/#PlaneColliderShape)     | 无界平面碰撞外形 |
| [CapsuleColliderShape](/apis/core/#CapsuleColliderShape) | 胶囊碰撞外形     |
