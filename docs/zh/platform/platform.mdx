...
| DPR Mode | [设备的像素比](/docs/core/canvas)，通过 `engine.canvas.setAutoResolution` 来控制画布的分辨率 <br/> **Auto：** 自动适配，即跟随显示尺寸并使用 devicePixelRatio <br/> **Fixed：** 开发者自行设置缩放参数 <Image src="https://mdn.alipayobjects.com/huamei_w6ifet/afts/img/A*EQOxSI8I8awAAAAAAAAAAAAADjCHAQ/fmt.webp" style={{zoom: "50%"}} /> 选择 Fixed 后，开发者可以自行输入缩放倍率 <Image src="https://mdn.alipayobjects.com/huamei_w6ifet/afts/img/A*-7YfTLegt_AAAAAAAAAAAAAADjCHAQ/fmt.webp" style={{zoom: "50%"}} />| 
