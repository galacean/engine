...
Logger.enable();
WebGLEngine.create({ canvas: "canvas", ktx2Loader: { workerCount: 4 } }).then((engine) => {
  ...
  const fileList = {
    etc1s: "https://mdn.alipayobjects.com/rms/afts/img/A*ONENTaxi-LAAAAAAAAAAAAAAARQnAQ/2d_etc1s.ktx2",
    uastc: "https://mdn.alipayobjects.com/rms/afts/img/A*aP4mRJcGi6AAAAAAAAAAAAAAARQnAQ/2d_uastc.ktx2"
  };
