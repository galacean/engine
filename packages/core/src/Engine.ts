...
export class Engine extends EventDispatcher {
  ...
  destroy(): void {
    if (this._sceneManager) {
      this._magentaTexture2D && this._magentaTexture2D.destroy(true);
      this._magentaTextureCube && this._magentaTextureCube.destroy(true);
      this._depthTexture2D && this._depthTexture2D.destroy(true);
