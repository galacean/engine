...
export class RenderContext {
  ...
  static pipelineStageKey: ShaderTagProperty = ShaderTagProperty.getByName("pipelineStage");
  ...
  replacementTagKey: ShaderTagProperty;
  pipelineStageValue: ShaderTagProperty;
