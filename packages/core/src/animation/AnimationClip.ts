...
export class AnimationClip extends EngineObject {
   ...
   */
  addEvent(functionName: string, time: number, parameter: AnimationEvent["parameter"]): void;
  ...
  addEvent(param: AnimationEvent | string, time?: number, parameter?: AnimationEvent["parameter"]): void {
