...
export class AnimatorStateDef {
   ...
   */
  addTransition(animatorState: AnimatorStateDef): AnimatorStateTransition;

  addTransition(transitionOrAnimatorState: AnimatorStateTransition | AnimatorStateDef): AnimatorStateTransition {
