...
export class ParticleShaderMacro {
  ...
  // );
  // static readonly SHADERDEFINE_SIZEOVERLIFETIMECURVE = ShaderMacro.getByName("SIZEOVERLIFETIMECURVE");
  // static readonly SHADERDEFINE_SIZEOVERLIFETIMECURVESEPERATE = ShaderMacro.getByName("SIZEOVERLIFETIMECURVESEPERATE");
  // static readonly SHADERDEFINE_SIZEOVERLIFETIMERANDOMCURVES = ShaderMacro.getByName("SIZEOVERLIFETIMERANDOMCURVES");
  // static readonly SHADERDEFINE_SIZEOVERLIFETIMERANDOMCURVESSEPERATE = ShaderMacro.getByName(
