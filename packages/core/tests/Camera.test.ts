...
describe("camera test", function () {
  ...
  it("world to viewport", () => {
    ...
    expect(out).toEqual({ x: 0.48459633827209475, y: 0.5086602294445037, z: -100 });
  });
  ...
  it("viewport to world", () => {
    ...
    camera.entity.transform.worldMatrix = new Matrix();
    const out = camera.viewportToWorldPoint(new Vector3(0.48459633827209475, 0.5086602294445037, -100), new Vector3());
