import { Canvas, Engine, Entity, IHardwareRenderer, RenderableComponent, Scene, Script } from "../src/index";
describe("ComponentsManager", () => {
  let engine: Engine = new Engine(<Canvas>{}, <IHardwareRenderer>{ init: jest.fn() });
  let scene;
  beforeEach(() => {
    scene = new Scene();
