...
export class Texture2DDecoder {
  static decode(engine: Engine, bufferReader: BufferReader, texture2D: Texture2D): AssetPromise<Texture2D> {
    return new AssetPromise((resolve, reject) => {
      ...
      texture2D ||= new Texture2D(engine, width, height, format, mipmap);
