...
import { createTag } from "../utils/helpers/html_elements.js";
export class IRenderer extends BaseRenderer {
  ...
  configAnimation = function(animData) {
    if (this.animationItem.wrapper) {
  ...
  renderFrame = function(num, forceRender) {
    if (
...
// WARN 与源代码不同 源代码有循环引用的问题
// extendPrototype([GLRenderer, ICompElement, CVBaseElement], CVCompElement);
