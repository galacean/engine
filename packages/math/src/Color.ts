...
export class Color implements IClone<Color>, ICopy<ColorLike, Color> {
   ...
   */
  private static readonly gammaToLinearSpaceBranchNumber_0 = Color.sigmoid(0);
  /**
  ...
  static gammaToLinearSpace(value: number): number {
    ...
    const isOver1 = Math.ceil(normalized - Color.gammaToLinearSpaceBranchNumber_1);
    const base = value / 12.92;
    // offset if value is greater than 1
    const offset = 0.055 * isOver1;
