...
export class GodraysEffect extends PostEffectNode {
  ...
  constructor( manager, props ){
    ...
    const godraysCombinePass = new GodraysCombinePassNode( 'GodraysCombine', godraysCombine, this, godraysRTC.texture );
  ...
  set depthTexture( value ){
    ...
    if( this._godraysPassA )
      this._godraysPassA.depthTexture = value;
  ...
  draw( feature, camera ) {
    ...
    if( this._godraysPassA )
      this._godraysPassA.sunScreen = [ sunScreen[0], sunScreen[1] ];
    if( this._godraysPassB )
      this._godraysPassB.sunScreen = [ sunScreen[0], sunScreen[1] ];
    if( this._godraysPassC )
      this._godraysPassC.sunScreen = [ sunScreen[0], sunScreen[1] ];
    if( this._godraysCombinePass )
      this._godraysCombinePass.sunScreen = [ sunScreen[0], sunScreen[1] ];
  ...
  set godRayIntensity( value ){
    ...
    if( this._godraysCombinePass )
      this._godraysCombinePass.godRayIntensity = value;
  ...
  set godRayLong( value ){
    ...
    if( this._godraysCombinePass )
      this._godraysCombinePass.godRayLong = value;
  ...
  set color( value ){
    ...
    if( this._godraysCombinePass )
      this._godraysCombinePass.color = value;
