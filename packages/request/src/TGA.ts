...
export class TGA {
  ...
  parseData( data ) {
    ...
    // Set shortcut
    this.header.hasEncoding = ( this.header.imageType === TGA.Type.RLE_INDEXED || this.header.imageType === TGA.Type.RLE_RGB   || this.header.imageType === TGA.Type.RLE_GREY );
    this.header.hasColorMap = ( this.header.imageType === TGA.Type.RLE_INDEXED || this.header.imageType === TGA.Type.INDEXED );
