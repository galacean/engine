...
export class RfuiAnimation {
  ...
  slideIn(param: any = {}) {
    ...
    this.material.diffuse.setWrapMode(config.wrapS || TextureWrapMode.CLAMP_TO_EDGE, config.wrapT || TextureWrapMode.CLAMP_TO_EDGE);

    return slide(this.material.uvOffset, (value) => {

      this.material.uvOffset = value;

    }, vec2.fromValues(0, 0), config);
  ...
  maskSlideIn(param: any = {}) {
    ...
    this.material.mask.setWrapMode(config.wrapS || TextureWrapMode.CLAMP_TO_EDGE, config.wrapT || TextureWrapMode.CLAMP_TO_EDGE);

    return slide(vec2.fromValues(0, 0), (value) => {
