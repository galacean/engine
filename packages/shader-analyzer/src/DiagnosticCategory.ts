...
export const DIAGNOSTIC_CATEGORY: Record<DiagnosticType, DiagnosticCategory> = {
  ...
  [DiagnosticType.AmbiguousEntryPoint]: DiagnosticCategory.PipelineIO,
  [DiagnosticType.GlFragColorWithMrt]: DiagnosticCategory.PipelineIO,
  [DiagnosticType.LegacyFragmentOutputConflict]: DiagnosticCategory.PipelineIO,
  [DiagnosticType.InvalidMrtOutput]: DiagnosticCategory.PipelineIO,
  [DiagnosticType.BareGlFragData]: DiagnosticCategory.PipelineIO,
  [DiagnosticType.NonConstFragmentOutputIndex]: DiagnosticCategory.PipelineIO,
