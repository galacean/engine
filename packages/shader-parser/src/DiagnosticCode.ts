/**
 * Diagnostic code registry. Lives with the producers (parser + codegen) so a
 * judgment site can stamp its code directly — analyzer consumes the code, never
 * re-derives it. Codes are never reused; deprecated checks keep their code.
 *
 * Layer prefixes:
...
export const DiagnosticCode = {
  ...
  // ── C0-codegen: struct/entry linkage ──
