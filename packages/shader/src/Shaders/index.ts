...
import _2D_Spine from "./2D/Spine.shader";
...
import _2D_UIOverlayBlit from "./2D/UIOverlayBlit.shader";
...
export const shaders: IShaderSource[] = [
  { source: _2D_Spine, path: "Shaders/2D/Spine.shader" },
  ...
  { source: _2D_UIOverlayBlit, path: "Shaders/2D/UIOverlayBlit.shader" },
