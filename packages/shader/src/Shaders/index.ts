...
import Lighting_ProbeDepthCapture from "./Lighting/ProbeDepthCapture.shader";
...
export const shaders: IShaderSource[] = [
  ...
  { source: Lighting_ProbeDepthCapture, path: "Shaders/Lighting/ProbeDepthCapture.shader" },
