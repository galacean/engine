Shader "particle-shader" {
  SubShader "Default" {
    Pass "Forward Pass" {
      ...
      #include "VelocityOverLifetime.glsl"
      #include "ForceOverLifetime.glsl"
      #include "ColorOverLifetime.glsl"
      #include "SizeOverLifetime.glsl"
      #include "RotationOverLifetime.glsl"
      #include "TextureSheetAnimation.glsl"
      #include "LimitVelocityOverLifetime.glsl"
