...
let mtl1 = new LambertMaterial("TestMaterial1");
mtl1.ambient = vec4.fromValues(1, 0, 0, 1);

let mtl2 = new LambertMaterial("TestMaterial2");
mtl2.ambient = vec4.fromValues(0, 1, 0, 1);

let mtl3 = new LambertMaterial("TestMaterial3");
mtl3.ambient = vec4.fromValues(0, 0, 1, 1);

let mtl4 = new LambertMaterial("TestMaterial3");
