...
for(i = 0; i < 30 ; i++) {
  let position = [(Math.random()-0.5) * positionRange, (Math.random()-0.5) * positionRange, (Math.random()-0.5) * positionRange];
...
for(i = 0; i < 30 ; i++) {
  let position = [(Math.random()-0.5) * positionRange, (Math.random()-0.5) * positionRange, (Math.random()-0.5) * positionRange];
  let rotation = [(Math.random()-0.5) * rotationnRange, (Math.random()-0.5) * rotationnRange, (Math.random()-0.5) * rotationnRange];
