  ...
  constructor (node, props) {
    ...
    const textures = [
      new Resource('texture', {
        type: 'texture',
        url:
          'https://gw.alipayobjects.com/mdn/rms_40d266/afts/img/A*keO2Qqo69V8AAAAAAAAAAABkARQnAQ'
      }),
      new Resource('texture', {
        type: 'texture',
        url:
          'https://gw.alipayobjects.com/mdn/rms_40d266/afts/img/A*opFaQ4b__-8AAAAAAAAAAABkARQnAQ'
      })
    ]
