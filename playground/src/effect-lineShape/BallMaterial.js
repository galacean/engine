...
function requireShapeTechnique(loader) {
 ...
 const FRAG_SHADER = `
        ...
        void main(void) {
          ...
          vec4 color = vec4(0.5, 0.5, 0.5, 0.6);
          gl_FragColor = color; 
