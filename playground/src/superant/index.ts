...
resourceLoader.batchLoad([gltfRes], (err, res) => {
  ...
  gltfRes.materials = [];
  let newMaterial = new BlinnPhongMaterial("TestMaterial");
  ...
  let newMaterial1 = new BlinnPhongMaterial("TestMaterial1");
  ...
  let newMaterial2 = new BlinnPhongMaterial("TestMaterial2");
