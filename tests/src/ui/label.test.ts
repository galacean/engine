...
describe("Label", async () => {
  ...
  it("wrap", () => {
    ...
    const label1 = textEntity.addComponent(Label);
    const transform1 = <UITransform>label1._transformEntity.transform;
    ...
    const label2 = textEntity.addComponent(Label);
    const transform2 = <UITransform>label2._transformEntity.transform;
    ...
    const label3 = textEntity.addComponent(Label);
    const transform3 = <UITransform>label3._transformEntity.transform;
