...
import type { TemporalFoamField } from "../../runtime/interaction/TemporalFoamField";
import type {
...
export class TemporalFoamTextureService {
  ...
  constructor(
    ...
    this._sourceTexture = factory.create(
      this._engine,
      field.resolutionX,
      field.resolutionZ,
      "InteractivePoolTemporalFoamSource"
    );
    this._historyTextures = [
      factory.create(this._engine, field.resolutionX, field.resolutionZ, "InteractivePoolTemporalFoamHistoryA"),
      factory.create(this._engine, field.resolutionX, field.resolutionZ, "InteractivePoolTemporalFoamHistoryB")
    ];
  ...
  get texture(): Texture2D | null {
    ...
    if (this._mutableMetrics.debugView === "source") return this._sourceTexture;
