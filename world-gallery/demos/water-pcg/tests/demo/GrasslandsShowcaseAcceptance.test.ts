...
function createRuntimeReadback(): GrasslandsAcceptanceRuntimeReadback {
  ...
  return Object.freeze({
    ...
    resources: Object.freeze({
      ...
      materialCreateCount: 6,
      materialDestroyCount: 0,
      localMapTextureCreateCount: 1,
      localMapTextureDestroyCount: 0,
      meshCreateCount: 12,
      meshDestroyCount: 0,
      sceneMeshCreateCount: 6,
      sceneMeshDestroyCount: 0,
      sceneMaterialCreateCount: 5,
      sceneMaterialDestroyCount: 0,
      sceneEntityCreateCount: 58,
      sceneEntityDestroyCount: 0,
      sceneMeshUploadCount: 6,
      environmentTextureCreateCount: 10,
      environmentTextureDestroyCount: 0,
      environmentMaterialCreateCount: 5,
      environmentMaterialDestroyCount: 0,
      environmentGltfResourceCreateCount: 5,
      environmentGltfResourceDestroyCount: 0,
      environmentMeshCreateCount: 5,
      environmentMeshDestroyCount: 0,
      environmentTemplateEntityCreateCount: 10,
      environmentTemplateEntityDestroyCount: 0,
      environmentActiveRockInstanceCount: 18,
      environmentRockInstanceCreateCount: 18,
      environmentRockInstanceDestroyCount: 0,
      renderTargetCount: 0,
    ...
    scene: Object.freeze({
      ...
      contactProbeCount: 3,
      terrainIndexCount: 142848,
      terrainMudStonesIndexCount: 73728,
      terrainSandIndexCount: 13824,
      terrainGrassMudIndexCount: 55296,
      terrainBedIndexCount: 73728,
      terrainBankIndexCount: 69120,
      ...
      terrainMaterialRegionIds: Object.freeze(["mud-stones", "sand", "grass-mud"]),
      ...
      landscapeRegionIds: Object.freeze(["far-river", "narrow-channel", "mid-bay", "near-shoal"]),
      landscapeExtentScaleXZ: Object.freeze([2.0109375, 3] as const),
      directLightCount: 1,
      skyboxCount: 0,
      planarCameraCount: 0,
...
describe("Grasslands Showcase Acceptance", () => {
  ...
  it("mounts the real engine/loader/scene path and keeps the observed gameplay registry empty", () => {
    ...
    expect(main).toContain("runtimeController.setSurfaceTimeOverride(resolveGrasslandsSurfaceTimeOverride(search))");
